...
export default function Welcome({ auth }) {
    ...
    const dateDes = new Date("09/15/2024");

    const timeDiff = Math.abs(
        Date.UTC(dateDes.getFullYear(), dateDes.getMonth(), dateDes.getDate()) -
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="text-black/50  dark:text-white/50 h-screen overflow-auto no-scrollbar">
                <div className="bg-[url('/images/store_01.png')] bg-cover bg-center bg-fixed">
                    <div className="relative flex flex-col items-center justify-center bg-gradient-to-b from-cyan-900/20 to-indigo-900/40 selection:bg-gray-100 selection:text-black">
                                    ...
                                    <nav className="-mx-3 flex flex-1 justify-end">
                                        {auth.user ? (
                                            <Link
                                                ...
                                                className="rounded-md px-3 py-2 font-semibold text-white ring-1 ring-transparent transition hover:text-white/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                            >
                                                Dashboard
                                            </Link>
                                        ) : (
                        ...
                        <div className="relative inset-0 h-[648px] flex items-center justify-center animate-jumpIn">
                            <div className="flex flex-col gap-4 justify-center items-center text-white font-extrabold">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="absolute inset-x-0 bottom-0 p-8  text-white">
                                            <h3 className="font-bold">
                                                Godzilla-Kong (4K Utra HD +
                                                Digital)
                                            </h3>
                                            <p className="text-xs">
                                                Lorem ipsum dolor sit amet
                                                consectetur adipisicing elit.
                                                Dolor, error. Officiis laborum
                                                temporibus
                                            </p>
                                            <button className="btn btn-sm btn-primary mt-2 rounded-md animate-bounce">
                                                Shop now
                                            </button>
                                        </div>
                                    </div>
