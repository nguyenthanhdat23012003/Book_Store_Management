    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'delivery' => [
                ...
                'completed_at' => $this->delivery->completed_at ? $this->delivery->completed_at->format('Y-m-d') : null,
                'rejected_at' => $this->delivery->rejected_at ? $this->delivery->rejected_at->format('Y-m-d') : null,
            ],
            'payment' => [
                'method' => $this->payment->method,
                'total' => $this->payment->total,
                'paid_at' => $this->payment->paid_at ? $this->payment->paid_at->format('Y-m-d') : null,
